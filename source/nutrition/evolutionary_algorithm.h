...
class evolutionary_algorithm {
  public:
    class individual {
      public:
        //individual(user_targets &rhs);
        //individual(user_diet rhs);
        //individual(user_diet &rhs);
        void mutation(nutrition_problem &p);
        void trampoline_mutation(nutrition_problem &p);
        individual crossover(nutrition_problem &p, individual &rhs);
        individual trampoline_crossover(nutrition_problem &p, individual &rhs);
  ...
  public:
    evolutionary_algorithm(nutrition_problem &p);
