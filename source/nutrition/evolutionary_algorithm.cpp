...
evolutionary_algorithm::evolutionary_algorithm(nutrition_problem &p)
...
void evolutionary_algorithm::display_status() {
    ...
    if (iteration == 6) {
        ...
        std::cout << " Nova calories_target_: " << _problem.getmeta() << std::endl;
    } else if (iteration == 5) {
        _problem.setTurn(5);
        ...
        _problem.setTurn(1);
        _problem.setMeta(400);
        // std::cout << " Nova calories_target_: " << _problem.calories_target_() << std::endl;
    }
...
void evolutionary_algorithm::individual::trampoline_mutation(
    nutrition_problem &p) {
    individual::mutation(p);
}

void evolutionary_algorithm::individual::mutation(nutrition_problem &p) {
...
evolutionary_algorithm::individual::trampoline_crossover(nutrition_problem &p,
                                              individual &rhs){
...
typename evolutionary_algorithm::individual
evolutionary_algorithm::individual::crossover(nutrition_problem &p,
                                                  individual &rhs) {
