...
//    double predictions::user_preferences::getImc() const {
//        return (this->weight / ((this->high / 100) * (this->high / 100)));
//    }
...
//
//    std::vector<double>
//    predictions::user_preferences::euclidean_distance(std::vector<std::vector<int>> _preferencesMatrix,
//                                                      std::vector<std::vector<double>> _normalizedRank, size_t size) {
//
...
//                it = std::find(_preferencesMatrix[j].begin(), _preferencesMatrix[j].end(), i);
...
//                                                      std::vector<std::vector<int>> _idsMatrix, std::vector<double> l2,
//                                                      size_t size) {
//
//        std::vector<std::vector<double>> itensMatrix(size, std::vector<double>(size));
//        std::vector<std::vector<double>> fullNormalizedMatrix(_normalizedRank.size(), std::vector<double>(size));
//
//        for (unsigned long i = 0; i < _idsMatrix.size(); i++) {
//            for (unsigned long j = 0; j < _idsMatrix[i].size(); j++) {
//                fullNormalizedMatrix[i][_idsMatrix[i][j] - 1] = _normalizedRank[i][j];
//            }
//        }
//
//        std::vector<std::vector<double>> itens(size, std::vector<double>(fullNormalizedMatrix.size()));
//
...
//    }
//
//    std::vector<double> predictions::user_preferences::score_calc(std::vector<std::vector<double>> _normalizedRank,
//                                                                  std::vector<std::vector<double>> _itensMatrix,
//                                                                  std::vector<std::vector<int>> _idsMatrix, int user,
//                                                                  size_t size) {
...
//            int aux = 0;
//            comparation = std::set_intersection(_localBreakfastPreferences.begin(), _localBreakfastPreferences.end(),
...
//    }
//
//    int predictions::user_preferences::snack1SimilaritySearch(int similarUser,
//                                                              std::vector<int> _localBreakfastPreferences,
...
//        std::vector<int> _breakfastSamePreferences(_localBreakfastPreferences.size()),
...
//
//            breakfastComparison =
//                std::set_intersection(_localBreakfastPreferences.begin(), _localBreakfastPreferences.end(),
//                                      _breakfastPreferencesMatrix[i].begin(), _breakfastPreferencesMatrix[i].end(),
//                                      _breakfastSamePreferences.begin());
//
//            snack1Comparison = std::set_intersection(_localSnack1Preferences.begin(), _localSnack1Preferences.end(),
//                                                     _snack1PreferencesMatrix[i].begin(),
//                                                     _snack1PreferencesMatrix[i].end(), _snack1SamePreferences.begin());
//
//            _breakfastSamePreferences.resize(breakfastComparison - _breakfastSamePreferences.begin());
//            _snack1SamePreferences.resize(snack1Comparison - _snack1SamePreferences.begin());
//
//            for (it = _breakfastSamePreferences.begin(); it != breakfastComparison; ++it)
//                aux = aux + 1;
//            for (it = _snack1SamePreferences.begin(); it != snack1Comparison; ++it)
//                aux = aux + 1;
//
...
//    }
//
//    int predictions::user_preferences::lunchSimilaritySearch(int similarUser,
//                                                             std::vector<int> _localBreakfastPreferences,
...
//
//        std::vector<int>::iterator breakfastCompare, snack1Compare, lunchCompare, it;
//        std::vector<int> _breakfastSamePreferences(_localBreakfastPreferences.size()),
//            _snack1SamePreferences(_localSnack1Preferences.size()),
...
//            breakfastCompare =
//                std::set_intersection(_localBreakfastPreferences.begin(), _localBreakfastPreferences.end(),
//                                      _breakfastPreferenceMatrix[i].begin(), _breakfastPreferenceMatrix[i].end(),
//                                      _breakfastSamePreferences.begin());
//
//            snack1Compare = std::set_intersection(_localSnack1Preferences.begin(), _localSnack1Preferences.end(),
//                                                  __snack1PreferencesMatrix[i].begin(),
//                                                  __snack1PreferencesMatrix[i].end(), _snack1SamePreferences.begin());
//
//            lunchCompare = std::set_intersection(_localLunchPreferences.begin(), _localLunchPreferences.end(),
//                                                 __lunchPreferencesMatrix[i].begin(), __lunchPreferencesMatrix[i].end(),
//                                                 _lunchSamePreferences.begin());
//
//            _breakfastSamePreferences.resize(breakfastCompare - _breakfastSamePreferences.begin());
//            _snack1SamePreferences.resize(snack1Compare - _snack1SamePreferences.begin());
//            _lunchSamePreferences.resize(lunchCompare - _lunchSamePreferences.begin());
//
//            for (it = _breakfastSamePreferences.begin(); it != breakfastCompare; ++it)
//                aux = aux + 1;
//            for (it = _snack1SamePreferences.begin(); it != snack1Compare; ++it)
//                aux = aux + 1;
//            for (it = _lunchSamePreferences.begin(); it != lunchCompare; ++it)
//                aux = aux + 1;
//
...
//        std::vector<std::vector<int>> _breakfastPreferenceMatrix, std::vector<int> _localSnack1Preferences,
//        std::vector<std::vector<int>> __snack1PreferencesMatrix, std::vector<int> _localLunchPreferences,
//        std::vector<std::vector<int>> __lunchPreferencesMatrix, std::vector<int> _localSnack2Preferences,
//        std::vector<std::vector<int>> __snack2PreferencesMatrix) {
//
//        std::vector<int>::iterator breakfastCompare, snack1Compare, lunchCompare, snack2Compare, it;
//        std::vector<int> _breakfastSamePreferences(_localBreakfastPreferences.size()),
//            _snack1SamePreferences(_localSnack1Preferences.size()),
//            _lunchSamePreferences(_localLunchPreferences.size()),
...
//                                                 _lunchSamePreferences.begin());
//
//            snack2Compare = std::set_intersection(_localSnack2Preferences.begin(), _localSnack2Preferences.end(),
//                                                  __snack2PreferencesMatrix[i].begin(),
//                                                  __snack2PreferencesMatrix[i].end(), _snack2SamePreferences.begin());
//
//            _breakfastSamePreferences.resize(breakfastCompare - _breakfastSamePreferences.begin());
//            _snack1SamePreferences.resize(snack1Compare - _snack1SamePreferences.begin());
//            _lunchSamePreferences.resize(lunchCompare - _lunchSamePreferences.begin());
//            _snack2SamePreferences.resize(snack2Compare - _snack2SamePreferences.begin());
//
//            for (it = _breakfastSamePreferences.begin(); it != breakfastCompare; ++it)
//                aux = aux + 1;
//            for (it = _snack1SamePreferences.begin(); it != snack1Compare; ++it)
...
//            for (it = _lunchSamePreferences.begin(); it != lunchCompare; ++it)
//                aux = aux + 1;
//            for (it = _snack2SamePreferences.begin(); it != snack2Compare; ++it)
//                aux = aux + 1;
//
//            if (aux > similariestScore) {
//                currentSimilariest = i;
...
//        std::vector<std::vector<int>> __snack1PreferencesMatrix, std::vector<int> _localLunchPreferences,
//        std::vector<std::vector<int>> __lunchPreferencesMatrix, std::vector<int> _localSnack2Preferences,
//        std::vector<std::vector<int>> __snack2PreferencesMatrix, std::vector<int> _localDinnerPreferences,
//        std::vector<std::vector<int>> __dinnerPreferencesMatrix) {
//
//        std::vector<int>::iterator breakfastCompare, snack1Compare, lunchCompare, snack2Compare, dinnerCompare, it;
//        std::vector<int> _breakfastSamePreferences(_localBreakfastPreferences.size()),
//            _snack1SamePreferences(_localSnack1Preferences.size()),
//            _lunchSamePreferences(_localLunchPreferences.size()),
//            _snack2SamePreferences(_localSnack2Preferences.size()),
...
//                                                  __snack2PreferencesMatrix[i].end(), _snack2SamePreferences.begin());
//
//            dinnerCompare = std::set_intersection(_localDinnerPreferences.begin(), _localDinnerPreferences.end(),
//                                                  __dinnerPreferencesMatrix[i].begin(),
//                                                  __dinnerPreferencesMatrix[i].end(), _dinnerSamePreferences.begin());
//
//            _breakfastSamePreferences.resize(breakfastCompare - _breakfastSamePreferences.begin());
//            _snack1SamePreferences.resize(snack1Compare - _snack1SamePreferences.begin());
//            _lunchSamePreferences.resize(lunchCompare - _lunchSamePreferences.begin());
//            _snack2SamePreferences.resize(snack2Compare - _snack2SamePreferences.begin());
//            _dinnerSamePreferences.resize(dinnerCompare - _dinnerSamePreferences.begin());
//
//            for (it = _breakfastSamePreferences.begin(); it != breakfastCompare; ++it)
//                aux = aux + 1;
//            for (it = _snack1SamePreferences.begin(); it != snack1Compare; ++it)
...
//            for (it = _snack2SamePreferences.begin(); it != snack2Compare; ++it)
//                aux = aux + 1;
//            for (it = _dinnerSamePreferences.begin(); it != dinnerCompare; ++it)
//                aux = aux + 1;
//
//            if (aux > similariestScore) {
//                currentSimilariest = i;
...
//        std::cout << "Os IDs dos alimentos ingeridos por " << u.getName() << " foram:" << std::endl;
...
//            std::cout << "ID:" << _breakfastPreferences[j] << ", Porçoes:" << _breakfastPortionPreferences[j]
//                      << std::endl;
//        }
//        std::cout << std::endl;
//
...
//            std::cout << "ID:" << _snack1Preferences[j] << ", Porçoes:" << _snack1PortionPreferences[j] << std::endl;
//        }
//        std::cout << std::endl;
//
//        std::cout << "Almoco: " << std::endl;
//        for (unsigned long j = 0; j < _lunchPreferences.size(); j++) {
//            std::cout << "ID:" << _lunchPreferences[j] << ", Porçoes:" << _lunchPortionPreferences[j] << std::endl;
//        }
//        std::cout << std::endl;
//
//        std::cout << "Lanche2: " << std::endl;
//        for (unsigned long j = 0; j < _snack2Preferences.size(); j++) {
//            std::cout << "ID:" << _snack2Preferences[j] << ", Porçoes:" << _snack2PortionPreferences[j] << std::endl;
//        }
//        std::cout << std::endl;
//
//        std::cout << "Jantar: " << std::endl;
//        for (unsigned long j = 0; j < _dinnerPreferences.size(); j++) {
//            std::cout << "ID:" << _dinnerPreferences[j] << ", Porçoes:" << _dinnerPortionPreferences[j] << std::endl;
//        }
//        std::cout << std::endl;
//
//        std::cout << "Ceia: " << std::endl;
//        for (unsigned long j = 0; j < _supperPreferences.size(); j++) {
//            std::cout << "ID:" << _supperPreferences[j] << ", Porçoes:" << _supperPortionPreferences[j] << std::endl;
//        }
//        std::cout << std::endl;
//    }
//
...
//    std::vector<int> predictions::user_preferences::getSnack1Preferences() const { return this->_snack1Preferences; }
//    std::vector<int> predictions::user_preferences::getSnack1PortionPreferences() const {
//        return this->_snack1PreferencesPortions;
//    }
//    std::vector<int> predictions::user_preferences::getLunchPreferences() const { return this->_lunchPreferences; }
//    std::vector<int> predictions::user_preferences::getLunchPortionsPreferences() const {
//        return this->_lunchPreferencesPortions;
//    }
//    std::vector<int> predictions::user_preferences::getSnack2Preferences() const { return this->_snack2Preferences; }
//    std::vector<int> predictions::user_preferences::getSnack2PreferencesPortions() const {
//        return this->_snack2PreferencesPortions;
//    }
//    std::vector<int> predictions::user_preferences::getDinnerPreferences() const { return this->_dinnerPreferences; }
//    std::vector<int> predictions::user_preferences::getDinnerPreferencesPortions() const {
//        return this->_dinnerPreferencesPortions;
//    }
//    std::vector<int> predictions::user_preferences::getPreferenciasCeia() const { return this->_supperPreferences; }
...
//    }
//    void predictions::user_preferences::setBreakfastPreferencesPortions(std::vector<int> _portionsInput) {
...
//    }
//    void predictions::user_preferences::setSnack1PortionPreferences(std::vector<int> _portionsInput) {
...
//    }
//    void predictions::user_preferences::setLunchPortionsPreferences(std::vector<int> _portionsInput) {
...
//    }
//    void predictions::user_preferences::setSnack2PreferencesPortions(std::vector<int> _portionsInput) {
...
//    }
//    void predictions::user_preferences::setDinnerPreferencesPortions(std::vector<int> _entradasPorcoes) {
...
//    }
//    void predictions::user_preferences::setSupperPreferencesPortions(std::vector<int> _portionsInput) {
